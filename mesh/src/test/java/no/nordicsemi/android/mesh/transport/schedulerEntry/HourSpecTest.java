...
public class HourSpecTest {
    ...
    public void should_have_the_correct_values() {
        ...
        assertEquals(0xE, ScheduleEntry.Hour.Specific(14).getValue());
    }

    @Test
    public void create_specific_hour_value_max_value_is_23() {
        assertEquals(0x17, ScheduleEntry.Hour.Specific(23).getValue());
        assertEquals(0x17, ScheduleEntry.Hour.Specific(30).getValue());
    }
}
